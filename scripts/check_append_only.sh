...
deleted_files=$(echo "$git_diff_output" | grep -v "Init.lean$" | grep -v "GoedelsPoetryLib/GoedelsPoetryLib.lean$" || true)
...
modified_files=$(echo "$git_diff_output" | grep -v "Init.lean$" | grep -v "GoedelsPoetryLib/GoedelsPoetryLib.lean$" || true)
...
added_files=$(echo "$git_diff_output" | grep -v "Init.lean$" | grep -v "GoedelsPoetryLib/GoedelsPoetryLib.lean$" || true)
